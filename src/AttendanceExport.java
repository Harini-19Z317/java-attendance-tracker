...
class Staff extends PSGclg   //Staff class inherits PSGclg class
{
    ...
    {   String[] subjectnames={"Linear Algebra","Data Structures","Computer Architecture","Discrete Structures","Object Oriented Programming","Economics for Engineers","Data Structures Lab","Object Oriented Programming Lab","Environmental Science"};
        ...
        for(int j=0;j<9;j++)
        {
            ...
            {   if(flag==0)
            {
                tableModel.insertRow(tableModel.getRowCount(), new Object[]{StudentID, Name, subjectnames[j],percentagearray[j]});
                flag = 1;
            }
            else
            {
                tableModel.insertRow(tableModel.getRowCount(), new Object[]{"","", subjectnames[j],percentagearray[j]});
            }
            }
        }
...
public class AttendanceExport
{
    ...
    //function getinput3() to get and return input for subject
    ...
    {
        System.out.println("1.FILTER BY STUDENT(PRESENT PERCENTAGE OF ALL SUBJECTS)");
        System.out.println("2.FILTER BY SUBJECT(VIEW PRESENT,LEAVE,EXCUSED AND UNEXCUSED ABSENCE,PRESENT PERCENTAGE)");
        ...
        try {
            ...
            if (choice == 1)   //staff
            {
                ...
                if (month == 1) {
                    ...
                    br = new BufferedReader(new FileReader("C:\\Users\\shivani\\Desktop\\Harini\\Java Project\\Attendance - August.csv"));
                } else if (month == 2) {
                    br = new BufferedReader(new FileReader("C:\\Users\\shivani\\Desktop\\Harini\\Java Project\\Attendance - September.csv"));
                } else if (month == 3) {
                    br = new BufferedReader(new FileReader("C:\\Users\\shivani\\Desktop\\Harini\\Java Project\\Attendance - October.csv"));
                } else if (month == 4) {
                    br = new BufferedReader(new FileReader("C:\\Users\\shivani\\Desktop\\Harini\\Java Project\\Attendance - Sem.csv"));
                }
                ...
                // percentage of all subjects for a given student
                if (filter == 1) {
                ...
                // present,late,excused and unexcused absence,present percent of all students for a given subject
                if (filter == 2) {
                ...
                } else if (filter == 3) //particular student and particular subject
                {
                    ...
                    if (rollno.charAt(3) == '3') {
                        ...
                        substaff[64 + (index % 9)].viewreportstaff(subject, 0, tableModel);
                    }
                ...
                }  else if (filter == 5) //to display the percentage of all the students for all the subjects
                {

                    DefaultTableModel percentagetableModel = createtablesubject();
                    for (k = 0; k < 73; k++) {
                        substaff[k].viewreport(percentagetableModel);
                    }
                } else if (filter == 6) {
                    double givenpercent = getinput5();
                    DefaultTableModel tableModel = new DefaultTableModel();
            ...
            } else if (choice == 2) //student
            {
                ...
                BufferedReader br = new BufferedReader(new FileReader("C:\\Users\\shivani\\Desktop\\Harini\\Java Project\\Attendance - Sem.csv"));
                ...
                //present,late,excused and unexcused absence,present percent of all subjects for a given student
                if (studchoice == 1) {
                    DefaultTableModel tableModel = new DefaultTableModel();
                    JTable table = new JTable(tableModel);
                    ...
                    Stud.viewreportstudent(tableModel);  //calling method of student class
                }
                //present percent of all subjects for a given student
                else
                {
                    DefaultTableModel percentagetableModel = createtablesubject();
